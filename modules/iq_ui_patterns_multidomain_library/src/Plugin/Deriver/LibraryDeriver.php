...
namespace Drupal\iq_ui_patterns_multidomain_library\Plugin\Deriver;
 ...
 *
 * @package Drupal\iq_ui_patterns_multidomain_library\Deriver
 */
class LibraryDeriver extends AbstractYamlPatternsDeriver {
  ...
  public static function create(ContainerInterface $container, $base_plugin_id) {
    return new static(
      ...
      $container->getParameter('iq_ui_patterns_multidomain_library.file_extensions'),
